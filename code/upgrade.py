...
class Upgrade:
    def __init__(self,player):
        ...
        self.width = self.display_surface.get_size()[0] // 6 #use len attributes for dyanmic
        self.create_items()
...
class Item:
    ...
    def display_names(self,surface,name,cost,selected):
        colour = TEXT_COLOR_SELECTED if selected else TEXT_COLOUR
        ...
        #cost
        cost_surface = self.font.render(f'{int(cost)}',False,colour)
    ...
    def display_bar(self,surface,value,max_value,selected):
        ...
        colour = BAR_COLOR_SELECTED if selected else BAR_COLOR
